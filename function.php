<?php
// Koneksi Database
$koneksi = mysqli_connect("localhost", "root", "", "db_joki");
...
function tambah($data)
{
    ...
    $sql = "INSERT INTO  mahasiswa VALUES ('$nis','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$jurusan','$email','$gambar','$alamat')";
...
function hapus($nis)
{
    ...
    mysqli_query($koneksi, "DELETE FROM  mahasiswa WHERE nis = $nis");
    return mysqli_affected_rows($koneksi);
}
...
function ubah($data)
{
    ...
    $sql = "UPDATE  mahasiswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', jurusan = '$jurusan', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nis = $nis";
